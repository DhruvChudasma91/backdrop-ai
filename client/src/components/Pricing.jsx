            ...
            <div className="container mx-auto px-4">
                ...
                <div className="mb-12 text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-black-400">
                        Select from our carefully photography package designed to meet your specific needs and budget.
                    </p>
                </div>
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    {plans.map((plan) => (
                        <div key={plan.id}
                            className={`relative pt-6 p-6 ${plan.popular ? 'backdrop-blur-lg rounded-2xl' : 'border-gray-800 rounded-xl'}
                                bg-[#1A1A1A] hover:transform hover:-translate-y-2 transition-all duration-300`}>

                            {plan.popular && (
                                <div className="absolute -top-1 left-1/2 -translate-x-1/2 rounded-full -translate-y-1/2 bg-purple-600 px-3 py-1 text-white text-sm font-semibold">
                                    Most Popular
                                </div>
                            )}
