    ...
    return (
        <div className="flex flex-col items-center justify-center bg-white px-4">
            ...
            <p className="text-gray-500 mb-8 text-center">
                Get a transparent background for your images in seconds.
            </p>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-10 flex flex-col items-center space-y-4">
                ...
                <label 
                    htmlFor="upload2" 
                    className="bg-indigo-600 hover:bg-blue-700 text-white font-semibold cursor-pointer px-6 py-3 rounded-full text-lg">
                    Upload Image
                </label>
